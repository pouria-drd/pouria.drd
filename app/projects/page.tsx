    ...
    return (
        <div className="min-h-dvh py-4 sm:py-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold text-center text-drd-neutral-950 dark:text-drd-neutral-300">
                    پروژه‌های من
                </h1>
                ...
                <div className="mt-8 mb-6">
                    <div className="relative flex items-center w-full max-w-full sm:max-w-lg mx-auto">
                        ...
                        />
                        <SearchIcon className="absolute left-2 text-drd-neutral" />
                    </div>
                </div>
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
                    {filteredProjects.length === 0 ? (
                        <p className="text-center text-drd-neutral sm:col-cols-2 md:col-span-3 r2l">
